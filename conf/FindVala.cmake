...
macro(vala_precompile output)
	...
	parse_arguments(ARGS "PACKAGES;OPTIONS" "" ${ARGN})
	set(vala_pkg_opts "")
	...
	add_custom_command(OUTPUT ${out_files} 
					   COMMAND ${VALA_EXECUTABLE} ARGS "-C" "-b" ${CMAKE_CURRENT_SOURCE_DIR} 
					   "-d" ${CMAKE_CURRENT_BINARY_DIR} ${vala_pkg_opts} ${ARGS_OPTIONS} ${in_files}
					   DEPENDS ${in_files})
